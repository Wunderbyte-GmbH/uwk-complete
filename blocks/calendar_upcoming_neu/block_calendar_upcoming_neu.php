 ...
 */
class block_calendar_upcoming_neu extends block_base {

    /**
     * Initialise the block.
     */
    public function init() {
        $this->title = get_string('pluginname', 'block_calendar_upcoming_neu');
    }
    ...
    public function get_content() {
        ...
        // 20200210 harald.bamberger@donau-uni.ac.at always use SITEID and categoryid null to always show all events from all courses of the user
        //$courseid = $this->page->course->id; // original
        //$categoryid = ($this->page->context->contextlevel === CONTEXT_COURSECAT) ? $this->page->category->id : null; // original
        $courseid = SITEID;
        $categoryid = null;
