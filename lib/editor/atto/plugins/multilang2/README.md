...
![Release](https://img.shields.io/badge/release-v1.12-blue.svg)  ![Supported](https://img.shields.io/badge/supported-3.9%2C%203.10%2C%203.11%2C%204.0%2C%204.1%2C%204.2%2C%204.3%2C%204.4%2C%204.5-green.svg)
...
The latest release is v1.12 (build 2021063000) for Moodle 3.9, 3.10, 3.11, 4.0, 4.1, 4.2, 4.3, 4.4 and 4.5.
